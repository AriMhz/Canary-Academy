...
export default function NewsDetailPage() {
    ...
    const relatedNews = content.news
            ...
            <section className="relative h-[60vh] min-h-[500px] w-full overflow-hidden">
                {news.videoUrl ? (
                    <iframe
                        width="100%"
                        height="100%"
                        src={`https://www.youtube.com/embed/${news.videoUrl.split('youtu.be/')[1]?.split('?')[0] || news.videoUrl.split('v=')[1]?.split('&')[0]}?autoplay=1&mute=1&loop=1&playlist=${news.videoUrl.split('youtu.be/')[1]?.split('?')[0] || news.videoUrl.split('v=')[1]?.split('&')[0]}`} // Autoplay background style
                        title={news.title}
                        frameBorder="0"
                        ...
                        <div className="flex flex-wrap items-center gap-8 text-white/90 border-t border-white/20 pt-6">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">Canary Team</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <aside className="space-y-8">
                            ...
                            <div className="bg-[#2C4F5E] rounded-2xl p-8 text-white shadow-xl relative overflow-hidden">
                                ...
                                <p className="text-white/80 text-sm mb-6 relative z-10 leading-relaxed">
                                    Get the latest news and updates from Canary Academy directly to your inbox.
                                </p>
                ...
                <section className="py-20 bg-muted/30">
                    <Container>
                        <div className="flex items-center justify-between mb-12">
                            <div>
                                <h2 className="text-3xl font-bold text-[#2C4F5E] mb-2">Related News</h2>
                                <p className="text-muted-foreground">More updates you might be interested in</p>
                            </div>
                            <Button asChild variant="outline" className="hidden md:flex">
                                <Link href="/news">View All <ArrowRight className="w-4 h-4 ml-2" /></Link>
                            </Button>
                        </div>
